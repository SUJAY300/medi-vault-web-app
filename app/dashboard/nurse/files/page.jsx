...
export default function NurseFilesPage() {
  ...
  const files = [
    {
      ...
      patient: "P-005 (Emily Brown)",
      diagnosingTeam: "Nurse Davis, Dr. Smith",
      date: "2024-01-20",
      type: "PDF",
    },
    {
      ...
      patient: "P-067 (Michael Lee)",
      diagnosingTeam: "Nurse Wilson",
      date: "2024-01-20",
      type: "DOC",
    },
    {
      id: 3,
      name: "Patient Notes",
      patient: "P-091 (Lisa Anderson)",
      diagnosingTeam: "Nurse Brown, Dr. Johnson",
      date: "2024-01-19",
      type: "PDF",
    },
    {
      ...
      name: "Lab Results",
      patient: "P-005 (Emily Brown)",
      diagnosingTeam: "Nurse Davis, Dr. Martinez",
      date: "2024-01-18",
      type: "PDF",
    },
  ]
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Patient Files</h1>
        <p className="text-slate-600">Access and manage patient files and documents.</p>
      </div>
                  ...
                  <td className="py-3 px-4 text-slate-600 text-xs">
                    <div className="flex flex-wrap gap-1">
                      {file.diagnosingTeam.split(",").map((person, idx) => (
                        <span key={idx} className="px-2 py-1 bg-emerald-100 text-emerald-700 rounded">
                          {person.trim()}
                        </span>
                      ))}
                    </div>
