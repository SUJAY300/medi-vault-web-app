...
const NAV_ITEMS = [
  { to: "/dashboard/doctor", end: true, label: "Dashboard", icon: "📊" },
  { to: "/dashboard/doctor/patients", end: false, label: "My Patients", icon: "👥" },
  { to: "/dashboard/doctor/upload", end: false, label: "Upload Files", icon: "📤" },
  { to: "/dashboard/doctor/files", end: false, label: "My Files", icon: "📁" },
  { to: "/dashboard/doctor/chatbot", end: false, label: "Chatbot", icon: "💬" },
];
